...
const Td = ({ className, colSpan, children }) => {
    return (
        <td
            className={`${className} whitespace-nowrap p-1 px-2 align-middle text-gray-700 dark:text-gray-400`}
            colSpan={colSpan}
        >
            {children}
        </td>
...
const Th = ({ className, children }) => {
    return (
        <th
            scope="col"
            className={`${className} h-8 px-2 text-left align-middle font-medium text-gray-700 dark:text-gray-400`}
        >
            {children}
        </th>
    );
